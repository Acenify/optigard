<aside class="sidebar">
    ...
    <div>
        <a href="{{ route('dashboard.index') }}" class="sidebar-logo">
            <img src="{{ asset('assets/images/optigard-logo.png') }}" alt="site logo" class="light-logo">
            <img src="{{ asset('assets/images/optigard-logo.png') }}" alt="site logo" class="dark-logo">
        ...
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li>
                  <a href="{{ route('customer.index') }}">
                    <iconify-icon icon="ic:round-people" class="menu-icon"></iconify-icon>
                    <span>Customer</span>
                </a>
            </li>
