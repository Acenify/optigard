                    ...
                    <tr>
                        <th style="text-align: left;">
                            <img
                                ...
                                src="{{ asset('assets/frontend/assets/dark-logo-optigard.png') }}"
                                alt="Logo Light"
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="text-center">
                            ...
                            <img src="{{ asset('assets/frontend/assets/dark-logo-optigard.png') }}" class="img-fluid" style="width: 15rem; transform: rotate(-5deg);" alt="cap Acegard">
